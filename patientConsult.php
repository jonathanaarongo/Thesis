                ...
                <div class="container-fluid">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                    <h3 class="card-title"><?php echo $_SESSION['f_name'] . ' ' . $_SESSION['l_name']; ?>'s Patient Vitals</h3>
                                </div>
                                <div class="card-body">
                    ...
                    <div class="row">
                        <a type="button" class="btn btn-info" href="patientFindingsAdd.php?key=<?php echo $_SESSION['key']; ?>">Add Findings</a>
                        <div class="col-md-12">
                            <div class="card">
                                <div class="card-header card-header-primary">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($data as $key => $data1) {
                                                    if ($_SESSION['user'] == $data1['ob'] && $_SESSION['email'] == $data1['email']) {
                                                        $i++;
                                                        ?>
                                                        <tr onclick="document.location = 'viewPatientList.php';">
                                                        <td><?php $_SESSION['reason'] = $data1['reason'];
                                                                        echo $data1['reason']; ?></td>
                                                            <td><?php $_SESSION['chiefComplaint'] = $data1['chiefComplaint'];
                                                                        echo $data1['chiefComplaint']; ?></td>
                                                            <td><?php $_SESSION['date'] = $data1['date'];
                                                                        echo $data1['date']; ?></td>
                                                            <td><?php $_SESSION['time'] = $data1['time'];
                                                                        echo $data1['time']; ?></td>
                                                            <td><?php $_SESSION['nextAppt'] = $data1['nextAppt'];
                                                                        echo $data1['nextAppt']; ?></td>
                                                            <?php
                                                                    $_SESSION['diagnosis'] = $data1['diagnosis'];
                                                                    $_SESSION['peFindings'] = $data1['peFindings'];
                                                                    ?>
                                                            <td>
