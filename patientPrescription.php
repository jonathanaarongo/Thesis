            ...
            <div class="col-md-12">
              <div class="card">
                <div class="card-header card-header-primary">
                  <h3 class="card-title"><?php echo $f_name, ' ', $l_name; ?>'s Prescription</h3>
                </div>
                <div class="card-body">
                  <!-- Grid row -->
                  <form action="store_prescription.php" method="post" enctype="multipart/form-data">
                    <div class="form-row">
                      <!-- Default input -->
                      <div class="col-md-12">
                        <label for="date">Prescribe Patient:</label>
