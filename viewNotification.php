        ...
        <div class="main-panel">
            ...
            <div class="content">
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-md-12">
                            <a href="notifWeight.php" class="btn btn-primary"><i class="material-icons">supervisor_account</i> Patient Weight</a>
                            <a href="notifBloodSugar.php" class="btn btn-primary"><i class="material-icons">face</i> Patient Blood Sugar</a>
                            <a href="notifBloodPressure.php" class="btn btn-primary"><i class="material-icons">favorite</i> Patient Blood Pressure</a>
                            <a href="notifKickCounter.php" class="btn btn-primary"><i class="material-icons">colorize</i> Patient Kick Counter</a>
                            <a href="notifAppointments.php" class="btn btn-primary"><i class="material-icons">file_copy</i> Patient Appointments</a>
                            <a href="notifInquiries.php" class="btn btn-primary"><i class="material-icons">file_copy</i> Patient Inquiries</a>
                        </div>
                    </div>
